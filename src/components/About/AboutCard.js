      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            Hi Everyone, I am <span className="purple">Aditya Vijay Singh </span>
            from <span className="purple"> Deoria, India.</span>
            <br />
            <br /> 
